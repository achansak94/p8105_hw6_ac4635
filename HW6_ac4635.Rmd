...
The first was fitting a full model that contains all variables provided and then I used a backward function to perform a backward stepwise regression to removed variables that are insignifcant with the outcome of interest, baby's birth weight. When I performed this stepwise regression method, the babysex,  bhead, blength, delwt, fincome, gaweeks, mheight, mrace, parity, ppwt, and smoken variables were included into the best fit model to compare with other models.  
